                ...
                <section>
                    ...
                    <div className="coffee_detail_container">
                        ...
                        <div className="coffee_detail">
                            <h4>{locationData.state.productName}<i onClick={activeHeart} className="fa-solid fa-heart-crack"></i></h4>                            
                                ...
                                <div className="product_info_content">
                                    <ul>
                                        ...
                                        <li className="sat_FAT">
                                            <dl>
                                                <dt>포화지방 (g)</dt>
                                                <dd>{locationData.state.productViewInfo.saturatedFat}</dd>
                                            </dl>
                                        </li>
                                ...
                                <li>
                                    <ul className="coffee_review_container">
                                        {locationData.state.reviewComment?
                                            locationData.state.reviewComment.map((item, indx) => 
                                            <li key={indx} className="coffee_review_contentbox">
                                                <div><i onClick={activeHeart} id="small" className="fa-solid fa-heart-crack"></i></div>
                                                <div className="coffee_review_name"><h4>{item.userName + " :"}</h4></div>
                                                <div className="coffee_review_content"><span>{item.mesege}</span></div>                                                                                            
                                            </li>
                                            )                                           
                                        : null}                                        
                                        {signUpVal ? <DetailReview activeHeart={activeHeart} inputVal={signUpVal} setSignUpVal={setSignUpVal} setAuth={setAuth}/> : null }
                                    </ul>
                                </li>
                            </ul>                           
                            </div>
                            <div className="coffee_review_inputbox">
                                <div className="coffee_review_input_area"><input type="text" value={inputVal} onChange={valHandle} onKeyPress={enterHandle} placeholder="리뷰를 입력해주세요" /></div>
                                <div className="coffee_review_inputbutton"><i onClick={signUp} className="fa-solid fa-pen"></i></div>
                            </div>
                        </div>                        
                    </div>
                </section>
